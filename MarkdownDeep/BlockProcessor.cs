...
namespace MarkdownDeep
{
	public class BlockProcessor : StringScanner
	{
		...
		public BlockProcessor(Markdown m, bool MarkdownInHtml, BlockType parentType)
		{
			m_markdown = m;
			m_bMarkdownInHtml = MarkdownInHtml;
		...
		public List<Block> ScanLines(string str)
		{
		...
		public List<Block> ScanLines(string str, int start, int len)
		{
			Reset(str, start, len);
			return ScanLines();
		}

		public bool StartTable(TableSpec spec, List<Block> lines)
		{
		...
		public string RenderLines(List<Block> lines)
		{
		...
		public void CollapseLines(List<Block> blocks, List<Block> lines)
		{
		...
		public enum MarkdownInHtmlMode
		{
		...
		public MarkdownInHtmlMode GetMarkdownMode(HtmlTag tag)
		{
		...
		public bool ProcessMarkdownEnabledHtml(Block b, HtmlTag openingTag, MarkdownInHtmlMode mode)
		{
