...
namespace MarkdownDeep
{
	...
	public class Markdown
	{
		...
		public string Transform(string str)
		{
			...
			return Transform(str, out defs, null);
		}
		...
		public string Transform(string str, out Dictionary<string, LinkDefinition> definitions, Action<Block,Token,string> customProcess)
		{
			...
			if (customProcess != null) {
				...
				{
					var b = blocks[i];
					b.RenderPlain(this, sb, customProcess);
				}
		...
		public bool RenderingTitledImage = false;
		...
		public int ClaimFootnote(string id)
		{
			Block footnote;
		...
		public void AddAbbreviation(string abbr, string title)
		{
			if (m_AbbreviationMap == null)
			{
				// First time
		...
		public void HtmlEncode(StringBuilder dest, string str, int start, int len)
		{
		...
		public void HtmlEncodeAndConvertTabsToSpaces(StringBuilder dest, string str, int start, int len)
		{
			m_StringScanner.Reset(str, start, len);
			var p = m_StringScanner;
			int pos = 0;
		...
		public SpanFormatter SpanFormatter
		{
			get
			{
